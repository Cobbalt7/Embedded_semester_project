...
#define CONFIG_PARAMETERS \
    CONF_XMACRO(CONF_MEAS_PERIOD_MS, 50, GET_SET_CONF_HANDLER_NAME(m_period)) \
    CONF_XMACRO(CONF_MEAS_OSS, 0, GET_SET_CONF_HANDLER_NAME(m_oss)) \
    CONF_XMACRO(CONF_USB_MEAS_NUM, 20, GET_SET_CONF_HANDLER_NAME(usb_m_num)) \
    CONF_XMACRO(CONF_DISPLAY_MEAS_NUM, 100, GET_SET_CONF_HANDLER_NAME(d_m_num)) \
