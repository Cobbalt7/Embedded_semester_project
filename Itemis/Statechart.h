...
#define SCVI_STATECHART_MAIN_REGION_READBMP180 0
#define SCVI_STATECHART_MAIN_REGION_DISPLAYDATA 0
#define SCVI_STATECHART_MAIN_REGION_SENDDATATOPC 0
...
typedef enum
{
	...
	Statechart_main_region_ReadBMP180,
	Statechart_main_region_DisplayData,
	Statechart_main_region_SendDataToPC
} StatechartStates;
...
{
	sc_boolean ev_timer_it_raised;
	sc_integer p_samples_disp;
	sc_integer p_samples_usb;
};
...
{
	sc_integer disp_sample;
	sc_integer usb_sample;
};
...
/*! Raises the in event 'ev_timer_it' that is defined in the default interface scope. */ 
extern void statechart_raise_ev_timer_it(Statechart* handle);
/*! Gets the value of the variable 'p_samples_disp' that is defined in the default interface scope. */ 
extern sc_integer statechart_get_p_samples_disp(const Statechart* handle);
/*! Sets the value of the variable 'p_samples_disp' that is defined in the default interface scope. */ 
extern void statechart_set_p_samples_disp(Statechart* handle, sc_integer value);
/*! Gets the value of the variable 'p_samples_usb' that is defined in the default interface scope. */ 
extern sc_integer statechart_get_p_samples_usb(const Statechart* handle);
/*! Sets the value of the variable 'p_samples_usb' that is defined in the default interface scope. */ 
extern void statechart_set_p_samples_usb(Statechart* handle, sc_integer value);
